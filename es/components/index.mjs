...
export { checkboxGroupEmits, checkboxGroupProps } from './checkbox/src/checkbox-group2.mjs';
...
export { segmentedEmits, segmentedProps } from './segmented/src/segmented2.mjs';
