...
export declare const dialogProps: {
    ...
    readonly headerType: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => import("./dialog-content").HeaderType) | (() => import("./dialog-content").HeaderType) | ((new (...args: any[]) => import("./dialog-content").HeaderType) | (() => import("./dialog-content").HeaderType))[], unknown, unknown, "", boolean>;
