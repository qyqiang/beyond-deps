import { createElementVNode, defineComponent, useAttrs, useSlots, computed, shallowRef, ref, nextTick, watch, onMounted, toRef, openBlock, createElementBlock, mergeProps, unref, createCommentVNode, Fragment, normalizeClass, renderSlot, createBlock, withCtx, resolveDynamicComponent, toDisplayString, withModifiers, normalizeStyle } from 'vue';
...
const _hoisted_2 = ["id", "minlength", "maxlength", "type", "disabled", "readonly", "autocomplete", "tabindex", "aria-label", "form", "autofocus"];
const _hoisted_3 = {
  key: 1,
  class: "float-label"
};
...
const _hoisted_11 = ["id", "minlength", "maxlength", "tabindex", "disabled", "readonly", "autocomplete", "aria-label", "form", "autofocus"];
const _hoisted_12 = {
  key: 0,
  class: "float-label"
};
      ...
      return openBlock(), createElementBlock("div", mergeProps(unref(containerAttrs), {
        ...
        _ctx.type !== "textarea" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          ...
          createElementVNode("div", {
            ...
            _ctx.floatLabel ? (openBlock(), createElementBlock("span", _hoisted_3, toDisplayString(_ctx.placeholder), 1)) : createCommentVNode("v-if", true),
            ...
            unref(suffixVisible) ? (openBlock(), createElementBlock("span", {
              ...
              createElementVNode("span", {
                ...
                unref(showPwdVisible) ? (openBlock(), createBlock(unref(ElIcon), {
                  ...
                  default: withCtx(() => [
                    passwordVisible.value ? (openBlock(), createElementBlock("svg", _hoisted_5, _hoisted_7)) : (openBlock(), createElementBlock("svg", _hoisted_8, _hoisted_10))
                  ]),
                  _: 1
                }, 8, ["class"])) : createCommentVNode("v-if", true),
          ...
          _ctx.floatLabel ? (openBlock(), createElementBlock("span", _hoisted_12, toDisplayString(_ctx.placeholder), 1)) : createCommentVNode("v-if", true),
          unref(isWordLimitVisible) ? (openBlock(), createElementBlock("span", {
            key: 1,
