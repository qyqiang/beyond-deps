...
exports.check = icon.check;
exports.circleCheck = icon.circleCheck;
exports.error = icon.error;
exports.iconPropType = icon.iconPropType;
exports.info = icon.info;
exports.loading = icon.loading;
exports.warning = icon.warning;
