...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const emptyValues = index$2.useEmptyValues(props, null);
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(index$4.ElTooltip), vue.mergeProps({
        ...
        "popper-class": [
          `${vue.unref(nsDate).namespace.value}-picker__popper`,
          _ctx.popperClass,
          "date-picker-popover"
        ],
        offset: 5,
