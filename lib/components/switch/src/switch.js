...
const _hoisted_4 = /* @__PURE__ */ vue.createElementVNode("svg", {
  ...
  /* @__PURE__ */ vue.createElementVNode("defs", null, [
    /* @__PURE__ */ vue.createElementVNode("clipPath", { id: "clip0_439_1388" }, [
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const switchSize = vue.ref("small");
      ...
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createElementVNode("span", {
          ...
          _ctx.inlinePrompt ? (vue.openBlock(), vue.createElementBlock("div", {
            ...
            }, vue.toDisplayString(vue.unref(checked) ? _ctx.activeText : _ctx.inactiveText), 11, _hoisted_3)) : vue.createCommentVNode("v-if", true)
          ...
          vue.createElementVNode("div", {
            ...
            _ctx.loading ? (vue.openBlock(), vue.createBlock(vue.unref(index$2.ElIcon), {
              ...
              vue.createVNode(vue.unref(index$2.ElIcon), { size: "8px" }, {
                default: vue.withCtx(() => [
                  _hoisted_4
                ]),
                _: 1
              ...
              _ctx.inactiveActionIcon ? (vue.openBlock(), vue.createBlock(vue.unref(index$2.ElIcon), { key: 0 }, {
                default: vue.withCtx(() => [
        ...
        !_ctx.inlinePrompt && (_ctx.activeIcon || _ctx.activeText) ? (vue.openBlock(), vue.createElementBlock("span", {
          ...
          !_ctx.activeIcon && _ctx.activeText && vue.unref(checked) ? (vue.openBlock(), vue.createElementBlock("span", {
            key: 1,
            "aria-hidden": !vue.unref(checked)
          }, vue.toDisplayString(_ctx.activeText), 9, _hoisted_5)) : vue.createCommentVNode("v-if", true),
          !_ctx.inactiveIcon && _ctx.inactiveText && !vue.unref(checked) ? (vue.openBlock(), vue.createElementBlock("span", {
            key: 2,
            "aria-hidden": vue.unref(checked)
          }, vue.toDisplayString(_ctx.inactiveText), 9, _hoisted_6)) : vue.createCommentVNode("v-if", true)
        ], 2)) : vue.createCommentVNode("v-if", true)
      ], 10, _hoisted_1);
    };
  }
