...
var index$5 = require('../../splitter/index.js');
              ...
              vue.withDirectives(vue.createVNode(vue.unref(index$4.ElOverlay), {
                ...
                default: vue.withCtx(() => [
                  vue.createVNode(vue.unref(focusTrap["default"]), {
                    ...
                    default: vue.withCtx(() => [
                      vue.createVNode(vue.unref(index$5.ElSplitter), {
                        class: vue.normalizeClass(vue.unref(ns).b("splitter")),
                        layout: vue.unref(isHorizontal) ? "horizontal" : "vertical"
                      }, {
                        default: vue.withCtx(() => [
                          ["rtl", "btt"].includes(_ctx.direction) ? (vue.openBlock(), vue.createBlock(vue.unref(index$5.ElSplitterPanel), {
                            key: 0,
                            onClick: vue.unref(onModalClick)
                          }, null, 8, ["onClick"])) : vue.createCommentVNode("v-if", true),
                          vue.createVNode(vue.unref(index$5.ElSplitterPanel), {
                              ...
                              vue.createElementVNode("div", vue.mergeProps({
                                ...
                                _ctx.withHeader ? (vue.openBlock(), vue.createElementBlock("header", {
                                  ...
                                  _ctx.showClose ? (vue.openBlock(), vue.createElementBlock("button", {
                                    ...
                                    vue.createVNode(vue.unref(index$6.ElIcon), {
                                      ...
                                      default: vue.withCtx(() => [
                                        (vue.openBlock(), vue.createElementBlock("svg", {
                                          ...
                                          vue.createElementVNode("path", { d: "M11 1.87969L10.1203 1L6 5.12072L1.87969 1L1 1.87969L5.12072 6L1 10.1203L1.87969 11L6 6.87928L10.1203 11L11 10.1203L6.87928 6L11 1.87969Z" })
                                        ]))
                                      ]),
                                      _: 1
                                    }, 8, ["class"])
                          ...
                          ["ltr", "ttb"].includes(_ctx.direction) ? (vue.openBlock(), vue.createBlock(vue.unref(index$5.ElSplitterPanel), {
                            key: 1,
                            onClick: vue.unref(onModalClick)
                          }, null, 8, ["onClick"])) : vue.createCommentVNode("v-if", true)
                        ]),
