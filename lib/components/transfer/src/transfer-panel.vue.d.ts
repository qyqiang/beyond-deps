...
declare const _default: import("vue").DefineComponent<{
    ...
    handleAllCheckedChange: (value: import("element-plus/es/components/checkbox").CheckboxValueType) => void;
    ...
    ElCheckbox: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
        ...
        "update:modelValue": (val: import("element-plus/es/components/checkbox").CheckboxValueType) => boolean;
