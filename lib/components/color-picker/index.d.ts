export declare const ElColorPicker: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    hue: import("vue").Ref<({
        ...
        $props: Partial<{
            ...
            color: {
                type: import("vue").PropType<import("./src/utils/color").default>;
                required: true;
            };
    ...
    alpha: import("vue").Ref<({
        ...
        $props: Partial<{
            ...
            readonly color: {
                readonly type: import("vue").PropType<import("./src/utils/color").default>;
    ...
    color: import("./src/utils/color").default;
    ...
    Predefine: import("vue").DefineComponent<{
        ...
        rgbaColors: import("vue").Ref<import("./src/utils/color").default[]>;
