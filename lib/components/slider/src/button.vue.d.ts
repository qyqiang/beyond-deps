declare const _default: import("vue").DefineComponent<{
    ...
    showTooltip: import("vue").Ref<import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>>;
    ...
    ElTooltip: import("../../../utils").SFCWithInstall<import("vue").DefineComponent<{
