...
declare const _default: import("vue").DefineComponent<{
    ...
    ImageViewer: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
        ...
        mode: import("vue").ShallowRef<import("element-plus/es/components/image-viewer").ImageViewerMode>;
        ...
        prev: () => void;
        next: () => void;
        handleActions: (action: import("element-plus/es/components/image-viewer").ImageViewerAction, options?: {}) => void;
