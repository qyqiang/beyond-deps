...
var constants$2 = require('../../../tooltip/src/constants.js');
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: contextEmit }) {
    ...
    const popper = vue.inject(constants$2.TOOLTIP_INJECTION_KEY);
    ...
    const setNow = () => {
      emit(dayjs__default["default"](/* @__PURE__ */ new Date()).locale(lang.value));
    };
        ...
        vue.createElementVNode("div", {
          ...
          vue.createElementVNode("div", {
            ...
            vue.withDirectives(vue.createElementVNode("div", {
              ...
              vue.createElementVNode("div", null, [
                vue.createElementVNode("div", {
                  class: vue.normalizeClass(vue.unref(dpNs).e("custom-now-btn"))
                }, [
                  vue.createVNode(vue.unref(index$4.ElButton), {
                    class: vue.normalizeClass(["icon-button", vue.unref(ppNs).e("icon-btn")]),
                    text: ""
                  }, {
                    default: vue.withCtx(() => [
                      vue.createVNode(vue.unref(index$5.ElIcon), {
                        ...
                        default: vue.withCtx(() => [
                          (vue.openBlock(), vue.createElementBlock("svg", {
                            ...
                            vue.createElementVNode("g", { id: "fi-ss-small-undo-alt" }, [
                ...
                vue.createElementVNode("div", {
                  ...
                  vue.createVNode(vue.unref(index$4.ElButton), {
                    ...
                    class: vue.normalizeClass(["d-arrow-left icon-button", vue.unref(ppNs).e("icon-btn")]),
                  ...
                  vue.withDirectives(vue.createVNode(vue.unref(index$4.ElButton), {
                    text: "",
                ...
                vue.createElementVNode("div", {
                  ...
                  vue.createVNode(vue.unref(index$4.ElButton), {
                    ...
                    default: vue.withCtx(() => [
                      vue.createVNode(vue.unref(index$5.ElIcon), { size: "16px" }, {
                        default: vue.withCtx(() => [
                          (vue.openBlock(), vue.createElementBlock("svg", {
                            xmlns: "http://www.w3.org/2000/svg",
                            width: "17",
            ...
            vue.createElementVNode("div", {
              ...
              }, null, 8, ["selection-mode", "date", "parsed-value", "disabled-date", "cell-class-name", "show-week-number"])) : vue.createCommentVNode("v-if", true),
