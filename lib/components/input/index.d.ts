export declare const ElInput: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly autosize: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => import("./src/input").InputAutoSize & {}) | (() => import("./src/input").InputAutoSize) | ((new (...args: any[]) => import("./src/input").InputAutoSize & {}) | (() => import("./src/input").InputAutoSize))[], unknown, unknown, false, boolean>;
