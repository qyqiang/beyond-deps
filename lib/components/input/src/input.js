...
var index$4 = require('../../../hooks/use-deprecated/index.js');
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps(vue.unref(containerAttrs), {
        ...
        _ctx.type !== "textarea" ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
          ...
          vue.createElementVNode("div", {
            ...
            _ctx.floatLabel ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_3, vue.toDisplayString(_ctx.placeholder), 1)) : vue.createCommentVNode("v-if", true),
            ...
            vue.unref(suffixVisible) ? (vue.openBlock(), vue.createElementBlock("span", {
              ...
              vue.createElementVNode("span", {
                ...
                vue.unref(showPwdVisible) ? (vue.openBlock(), vue.createBlock(vue.unref(index$5.ElIcon), {
                  ...
                  default: vue.withCtx(() => [
                    passwordVisible.value ? (vue.openBlock(), vue.createElementBlock("svg", _hoisted_5, _hoisted_7)) : (vue.openBlock(), vue.createElementBlock("svg", _hoisted_8, _hoisted_10))
                  ]),
                  _: 1
                }, 8, ["class"])) : vue.createCommentVNode("v-if", true),
          ...
          _ctx.floatLabel ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_12, vue.toDisplayString(_ctx.placeholder), 1)) : vue.createCommentVNode("v-if", true),
          vue.unref(isWordLimitVisible) ? (vue.openBlock(), vue.createElementBlock("span", {
            key: 1,
