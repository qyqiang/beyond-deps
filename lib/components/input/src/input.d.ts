...
export declare const inputProps: {
    ...
    readonly autosize: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => InputAutoSize & {}) | (() => InputAutoSize) | ((new (...args: any[]) => InputAutoSize & {}) | (() => InputAutoSize))[], unknown, unknown, false, boolean>;
