...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const verticalProperty = vue.computed(() => placement.value.startsWith("top") ? "top" : "bottom");
        ...
        default: vue.withCtx(() => [
          vue.withDirectives(vue.createElementVNode("div", {
            ...
            class: vue.normalizeClass([
              ...
              vue.unref(ns).is("alert", _ctx.alert),
              vue.unref(ns).is("bottom", vue.unref(verticalProperty) === "bottom"),
            ...
            vue.unref(iconComponent) ? (vue.openBlock(), vue.createBlock(vue.unref(index$1.ElIcon), {
              ...
              color: _ctx.plain ? vue.unref(badgeType) === "warning" ? "#2a3f4d" : "#fff" : vue.unref(badgeType) === "warning" ? "#d9a514" : "#2a3f4d",
              size: "16px",
              innerHTML: vue.unref(iconComponent)
            }, null, 8, ["class", "color", "innerHTML"])) : vue.createCommentVNode("v-if", true),
            vue.renderSlot(_ctx.$slots, "default", {}, () => [
              !_ctx.dangerouslyUseHTMLString ? (vue.openBlock(), vue.createElementBlock("p", {
                key: 0,
                class: vue.normalizeClass(vue.unref(ns).e("content"))
              }, [
                _ctx.title ? (vue.openBlock(), vue.createElementBlock("span", {
                  key: 0,
            ...
            _ctx.label ? (vue.openBlock(), vue.createBlock(vue.unref(index$2.ElButton), {
              key: 2,
              text: "",
              class: vue.normalizeClass(vue.unref(ns).e("labelBtn")),
